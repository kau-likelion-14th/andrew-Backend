...
public class TodoCalendarService {
    ...
    public TodoCalendarMonthResponse getMonthRemainingCounts(
            Long userId, int year, int month)
    {
        ...
        Map<LocalDate, Long> totalCountByDate = todoDates
                .stream()
                .collect(groupingBy(TodoDate::getDate, counting()));

        Map<LocalDate, Long> remainingCountByDate = todoDates
                .stream()
